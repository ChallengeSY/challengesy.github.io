...
function dmBase(strength) {
	const dmCommon = "Non-player <q>boss</q> ship that will instantly destroy any undefended "+conceptLink("planet")+" it comes into contact with." +
		"<br />Equipped with "+conceptLink("Tactics")+" level 2 and "+conceptLink("Scanning")+" level 2. Immune to "+conceptLink("asteroids")+", "+conceptLink("black hole")+"s, "+conceptLink("fighters")+", and "+conceptLink("mines")+"." +
...
function showBox(concept) {
	...
	switch (concept.toLowerCase()) {
		...
		case "alien ship":
			...
			break;
		case "attack":
			displayTxt = "<b>Attack</b><br />Determines the "+conceptLink("Priority Class")+" this ship has in "+conceptLink("battle")+" (A-E), followed by the maximum d10 roll allowed to score a hit.<br />(Assuming no enemy "+conceptLink("Defense")+" modifiers.)" +
		...
		case "fleet size bonus":
			...
			break;
		case "hull size":
			displayTxt = "<b>Hull Size</b><br />Determines the number of hits a ship can take before being destroyed. Also determines the "+conceptLink("maintenance")+" cost of a ship per economic phase.";
			break;
		case "maintenance":
		...
		case "non-combat ship":
			...
			break;
		case "priority class":
			displayTxt = "<b>Priority Class</b><br />First factor that determines who can attack first (A &gt; B &gt; C &gt; D &gt; E) each "+conceptLink("battle")+" "+conceptLink("round")+". "+conceptLink("Tactics")+" "+conceptLink("technology")+" can break ties.";
			break;
		case "retreat":
		...
		case "exploration":
			...
			break;
		case "fighter":
			displayTxt = "<b>Fighter Technology</b><br />Allows building "+conceptLink("Carrier")+"s and "+conceptLink("Fighters")+".";
			break;
		case "minelaying":
		...
		case "home system":
			...
			break;
		case "lost":
			displayTxt = "<b>Lost in Space</b><br />If discovered, this system sends ships in a different, involuntary direction. Although unclear for a solitaire game, in a regular game, another player directs these ships. The counter is then removed afterwards.";
			break;
		case "planet":
		...
		case "carrier":
			// Fall through
		case "cv":
			displayTxt = "<b>Carrier</b><br />Combat transport craft, able to carry "+conceptLink("Fighters")+" into space";
			displayTxt = displayTxt + stats(12, "E3", 0, 1) + "<br /><b>Required Tech</b>: "+conceptLink("Fighter")+" level 1";
			break;
		case "fighters":
			// Fall through
		case "f":
			displayTxt = "<b>Fighters</b><br />Small craft, requires a "+conceptLink("Carrier")+" to move into space. Comes in three levels";
			displayTxt = displayTxt + stats(5, "B5", 0, 1) + "<br /><b>Required Tech</b>: "+conceptLink("Fighter")+" level 1";
			displayTxt = displayTxt + stats(5, "B6", 0, 1) + "<br /><b>Required Tech</b>: "+conceptLink("Fighter")+" level 2";
